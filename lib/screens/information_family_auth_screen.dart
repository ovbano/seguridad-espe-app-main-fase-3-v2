  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          'Mis contactos',
          style: TextStyle(color: Color.fromARGB(221, 251, 251, 251)),
        ),
      ),
              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    ...
                    const Text(
                      "Agrega los números de teléfono de tus contactos en caso de emergencia, para que puedan recibir alertas de tus seres queridos.",
                      style: TextStyle(
            ...
            decoration: const InputDecoration(
              ...
              labelStyle: TextStyle(
                color: Color.fromARGB(
                    255, 32, 93, 48), // Color del texto del label
              ),
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              ...
              style: TextButton.styleFrom(
                foregroundColor: const Color(0xFF1F5545),
              ),
              child: const Text(
                'Eliminar',
                style: TextStyle(
